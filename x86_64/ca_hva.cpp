 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ca_hva /root/autodl-tmp/neuron-network-twcnyh/ca_hva.mod\n");
...
static int  rates ( _internalthreadargsprotocomma_ double _lv ) {
 ...
 _lalpha = 0.055 * ( - 27.0 - _lv ) / ( exp ( ( - 27.0 - _lv ) / 3.8 ) - 1.0 ) ;
   ...
   minf = _lalpha * mtau ;
   _lalpha = 0.000457 * exp ( ( - 13.0 - _lv ) / 50.0 ) ;
   _lbeta = 0.0065 / ( exp ( ( - 15.0 - _lv ) / 28.0 ) + 1.0 ) ;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/root/autodl-tmp/neuron-network-twcnyh/ca_hva.mod";
